                ...
                <li class="tocify-item level-1" data-unique="introduction">
                    <a href="#introduction">Introduction</a>
                                    ...
                                    <ul id="tocify-subheader-introduction" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="english-version">
...
<p>This documentation covers all API endpoints for the Prayerkids HR system.</p>
<h3 id="summary">Summary</h3>
<ul>
<li>The Base URL follows the backend environment configuration.</li>
<li>All responses use a standard envelope: <code>meta</code>, <code>data</code> (success), and <code>errors</code> (failure).</li>
<li>Most endpoints require Sanctum Bearer token authentication.</li>
</ul>
<h3 id="quick-start">Quick Start</h3>
<ol>
<li>Log in via <code>POST /api/login</code>.</li>
<li>Get <code>access_token</code> from the response.</li>
<li>Send header: <code>Authorization: Bearer {token}</code>.</li>
<li>Use the remaining endpoints based on user role and permission.</li>
</ol>
...
<p>Use the Bearer token from the login endpoint. Header format: <code>Authorization: Bearer {token}</code>.</p>
